def chia_het_cho_5(so_nhi_phan):
    ...
    if so_thap_phan %5==0:
        ...
        return False
chuoi_so_nhi_phan = input("Nhập chuổi số nhị phân đi bạn (Cách nhau bởi dấu phẩy nhé): ")
...
if len(so_chia_het_cho_5) >0:
    ...
    print("Không có số nhị phân nào chia hết cho 5 trong chuỗi đã nhập đâu nha. ")